...
/***/ function(module, exports, __webpack_require__) {
	...
	var L = global.L || __webpack_require__(23);
	var Promise = __webpack_require__(25);
	var ajax = __webpack_require__(28);
	...
	L.Util.ajax = ajax;
	L.Util.jsonp = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../css-loader/index.js!!./leaflet.awesome-markers.css", function() {
				var newContent = require("!!./../../css-loader/index.js!!./leaflet.awesome-markers.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
