...
/***/ function(module, exports, __webpack_require__) {
	...
	leaflet = __webpack_require__(18);
	...
	var adherents = L.geoJson.ajax("data/adherents_lr.geojson", {
	  ...
	  pointToLayer: function (feature, latlng) {
	    ...
	    var icone = feature.properties.type == 'carrier' ? 'cog' : feature.properties.type == 'Etat' ? 'flag' : feature.properties.type == 'Collectivité' ? 'institution' : feature.properties.type == 'Industriel' ? 'industry' : feature.properties.type == 'Association' ? 'group' : feature.properties.type == 'Particulier' ? 'male' : 'cog';
	    ...
	    return new L.marker(latlng, option).bindPopup(feature.properties['nom']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var L = global.L || __webpack_require__(18);
	...
	L.Util.ajax = ajax;
	L.Util.jsonp = __webpack_require__(24);
